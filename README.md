# -app_-for_work_json_xml
a graphical application capable of importing JSON/XML files and displaying their contents in tabular form using MVC
...
Для разработки рекомендуется использовать Qt5, с++ не старше 14 стандарта и систему сборки qmake.
Основные требования:
